...
* An input file ending in .in may be given, or argv arguments may be given in a file ending in .argv. Behaviour if both are provided is unspecified but the test runner currently does not respect both.
